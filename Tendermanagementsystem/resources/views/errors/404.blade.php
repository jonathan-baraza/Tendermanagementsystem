...
<body>
	<center>
	<nav id="top" class="p-3" style="background-color: white;box-shadow:  0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
	  <!-- Brand -->
	  <div class="" href="/home">
...
<br><br>
	...
	<div>
		<br><br>
		<h1 class="text-danger">The requested page was not found on this server.</h1>
		<br>
		<img style="width:30%;" src="/storage/images/404 (1).jpg"><br>
		<br>
		<br>
		<a href="/home" class="btn btn-outline-primary">visit our homepage.</a>
	</div>
	</center>
<br><br>
	<div style="width: 100%" class="bg-dark p-3 mt-5">
